...
export const hoppersCourses: HoppersCourse[] = [
  ...
  },
  {
    ...
    category: "B2C",
    description: "SAP S/4HANA Supply Chain Experto (Warehouse)",
    profiles: ["ewm_tm", "consultant_mm", "consultant_pp"],
    editions: [
      { period: "Sep 2026 (2ª)", type: "webinar" },
      { period: "Ene 2027 (2ª)", type: "confirmed" },
      { period: "Sep 2027 (2ª)", type: "confirmed" },
    ],
  },
  {
    ...
    profiles: [],
    editions: [
      { period: "Jun 2026 (2ª)", type: "webinar" },
      { period: "Sep 2026 (2ª)", type: "confirmed" },
      { period: "Dic 2026 (2ª)", type: "webinar" },
      { period: "Mar 2027 (2ª)", type: "confirmed" },
      { period: "Jun 2027 (2ª)", type: "webinar" },
      { period: "Sep 2027 (1ª)", type: "confirmed" },
    ],
  },
  {
    ...
    profiles: [],
    editions: [
      { period: "Oct 2026 (2ª)", type: "webinar" },
      { period: "Ene 2027 (2ª)", type: "confirmed" },
  ...
  },
  {
    ...
    category: "B2C",
    description: "SAP Usuario Admin de Concur Expenses / Travel + NUVA",
    durationHours: 8,
    profiles: ["basis_admin", "consultant_fi_co"],
    editions: [
      { period: "Jun 2026 (2ª)", type: "confirmed" },
      { period: "Nov 2026 (1ª)", type: "confirmed" },
  ...
  },
  {
    ...
    category: "B2C",
    description: "SAP Usuario Admin de Concur Travel & Request + NUVA",
    durationHours: 8,
    profiles: ["basis_admin", "consultant_fi_co"],
    editions: [
      { period: "Jul 2026 (1ª)", type: "confirmed" },
      { period: "Nov 2026 (2ª)", type: "confirmed" },
